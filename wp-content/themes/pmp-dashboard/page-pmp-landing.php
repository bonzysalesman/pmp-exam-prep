<?php
/**
 * Template Name: PMP Landing Page
 * Page Slug: pmp-landing
 */
...
<section class="relative py-20 lg:py-32 overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 text-center">
        <h1 class="text-5xl xl:text-6xl font-black leading-tight text-secondary mb-6 uppercase" style="line-height: 1.1618;">
            <?php echo get_field('hero_title') ?: 'Pass Your PMP® Exam the First Time:'; ?>
            <span class="text-primary"><?php echo get_field('hero_subtitle') ?: 'Practical, ECO-Focused Prep'; ?></span>
        </h1>
        <p class="text-xl font-light text-secondary mb-8 max-w-2xl mx-auto leading-normal">
            <?php echo get_field('hero_description') ?: 'Stop wasting time and money. Get the clear, structured guidance you need, based *directly* on the official PMP® Exam Content Outline (ECO). Designed for serious first-time passers by a fellow PMP® candidate.'; ?>
        </p>
        ...
        <div class="flex flex-wrap justify-center items-center gap-8 text-sm text-gray-600">
            <div class="flex items-center">
                ...
                <span><?php echo get_field('students_count') ?: '1,000+'; ?> Students</span>
            </div>
            <div class="flex items-center">
                <i class="fas fa-star text-yellow-500 mr-2"></i>
                <span><?php echo get_field('rating') ?: '4.9/5'; ?> Rating</span>
            </div>
            <div class="flex items-center">
                <i class="fas fa-certificate text-primary mr-2"></i>
                <span><?php echo get_field('pass_rate') ?: '95%'; ?> Pass Rate</span>
            </div>
        </div>
    </div>
</section>
