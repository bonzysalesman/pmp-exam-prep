    ...
    <main class="max-w-7xl mx-auto px-6 py-20 text-center">
		...
		<section class="error-404 not-found">
			<header class="page-header">
				...
				<p class="text-2xl font-semibold text-secondary mb-8"><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'pmp-dashboard' ); ?></p>
			</header><!-- .page-header -->

			<div class="page-content text-gray-600">
				<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'pmp-dashboard' ); ?></p>

				<?php
				get_search_form();
				?>
                <div class="mt-8">
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="bg-primary text-white px-6 py-3 rounded-lg hover:bg-primary-dark transition-colors duration-300">
                        Return to Homepage
                    </a>
                </div>
			</div><!-- .page-content -->
