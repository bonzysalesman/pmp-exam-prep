    <!-- Footer -->
    <?php if (is_front_page() || is_page('pmp-landing')) : ?>
        <!-- Homepage/Landing Page Footer -->
    ...
    <?php else : ?>
        ...
        <footer class="mt-8 lg:mt-12 pt-6 lg:pt-8 border-t border-gray-200 bg-white">
            <div class="max-w-7xl mx-auto px-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 lg:gap-8 mb-6">
                    <div class="md:col-span-2">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/mohlomi_institute_logo.png" alt="Mohlomi Institute" class="h-8 lg:h-10 mb-3">
                        <p class="text-xs lg:text-sm text-gray-600">Mohlomi Institute provides focused, practical, and ethical training solutions for project management professionals.</p>
                    </div>
                    <div>
                        <h3 class="text-xs lg:text-sm font-semibold text-gray-900 uppercase tracking-wide mb-3">Quick Links</h3>
                        <ul class="space-y-2 text-xs lg:text-sm text-gray-600">
                            <li><a href="<?php echo get_permalink(get_page_by_path('dashboard')); ?>" class="hover:text-primary transition-colors">Dashboard</a></li>
                            <li><a href="<?php echo get_post_type_archive_link('work_group'); ?>" class="hover:text-primary transition-colors">Work Groups</a></li>
                            <li><a href="<?php echo get_post_type_archive_link('practice_test'); ?>" class="hover:text-primary transition-colors">Practice Tests</a></li>
                            <li><a href="<?php echo get_permalink(get_page_by_path('resources')); ?>" class="hover:text-primary transition-colors">Resources</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 class="text-xs lg:text-sm font-semibold text-gray-900 uppercase tracking-wide mb-3">Support</h3>
                        <ul class="space-y-2 text-xs lg:text-sm text-gray-600">
                            <li><a href="#" class="hover:text-primary transition-colors">Help Center</a></li>
                            <li><a href="#" class="hover:text-primary transition-colors">Contact Us</a></li>
                            <li><a href="<?php echo get_permalink(get_page_by_path('community')); ?>" class="hover:text-primary transition-colors">Community</a></li>
                ...
                <div class="pt-4 lg:pt-6 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center">
                    <p class="text-xs text-gray-500 mb-2 sm:mb-0">© <?php echo date('Y'); ?> Mohlomi Institute. All rights reserved.</p>
                    <div class="flex space-x-4">
                        <a href="#" class="text-gray-400 hover:text-primary transition-colors">
